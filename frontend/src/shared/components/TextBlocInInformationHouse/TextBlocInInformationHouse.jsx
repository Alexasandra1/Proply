...
export function TextBlocInInformationHouse(props) {
  return (
    <div className={`textBlocInInformationHouse__block ${props.styleTextBlocInInformationHouse}`}>
      ...
      <p className={`textBlocInInformationHouse__block__price`}>Price:{props.priceStyleTextBlocInInformationHouse}</p>
      <p className={`textBlocInInformationHouse__block__description`}>Description:{props.descriptionStyleTextBlocInInformationHouse}</p>
